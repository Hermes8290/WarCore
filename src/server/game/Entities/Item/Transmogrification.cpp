...
const char* Transmogrification::GetSlotName(uint8 slot, WorldSession* /*session*/) const
{
    ...
    switch (slot)
    {
        ...
        case EQUIPMENT_SLOT_SHOULDERS: return  "Épaules";// session->GetTrinityString(LANG_SLOT_NAME_SHOULDERS);
        ...
        case EQUIPMENT_SLOT_FEET: return  "Pïeds";// session->GetTrinityString(LANG_SLOT_NAME_FEET);
        ...
        case EQUIPMENT_SLOT_RANGED: return  "À distance";// session->GetTrinityString(LANG_SLOT_NAME_RANGED);
